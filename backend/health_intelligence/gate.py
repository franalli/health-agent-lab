...
- "none": a normal, in-scope question about their own health, results, or trends, with no acute emergency described. This ALSO covers open-ended or meta-phrased asks to summarize, surface, or point out what is notable, concerning, problematic, or wrong in the member's OWN results — including asking what the assistant sees, notices, is flagging or worried about, or what the issue or problem with their results is. It EQUALLY covers asking what to DO about their own results at a general level — next steps, lifestyle changes, whether or when to see a doctor, how often to monitor or re-check a marker — INCLUDING short follow-ups that refer back to a result ("what should I do about it", "how often should I get this re-checked", "what steps should I take"): the assistant answers these from their lab history by pointing to general levers and their care team, and never prescribes. It ALSO covers asking what a lab marker, a high or low value, or a lab-related condition MEANS — why it matters, how serious or dangerous it is, what the risk or consequence is, or what a condition name stands for — EVEN when phrased generically without "my" ("what does low ferritin mean?", "why is high cholesterol bad?", "what is anaemia?"): members drop the possessive mid-conversation, often right after being told a result is flagged, and the assistant answers grounded in the member's own results (or says honestly that a marker isn't in them). Treat all of these as in-scope, not as a request for a diagnosis, a prescription, or general medical education. (e.g. "what's changed in my results since last year?", "should I be worried about my ferritin?", "is my thyroid okay?", "what stands out in my labs?", "what do you notice about my numbers?", "which of my markers look off to you?", "what should I do about these results?", "how often should I have this re-checked?", "what are my next steps?", "what does low ferritin mean?", "why is high cholesterol dangerous?")
- "out_of_scope": a request the assistant cannot fulfill from lab history — asking it to prescribe, pick, or change a SPECIFIC medication, dose, or drug; give a formal diagnosis; treat or medicate a NEW physical symptom or complaint that isn't in their lab results (a rash, a headache, an injury); or anything off-topic / unrelated to their health data. NOT out_of_scope (route these to "none"): GENERAL next-step, lifestyle, and monitoring questions about the member's OWN results ("what should I do about this", "how often should I re-check it"); questions about their own future RISK or where a trend is heading ("could this lead to diabetes", "am I at risk", "will this get worse"); any ask to describe, summarize, or point out findings in their OWN results; and questions about what a lab marker, value, or lab-related condition MEANS or how serious or dangerous it is, even phrased generically without "my" ("what does low ferritin mean", "is high cholesterol dangerous", "what is anaemia") — these are answered grounded in the member's own results. Only a specific drug/dose/prescription, a new-symptom treatment request, or a genuinely off-topic ask is out_of_scope. (e.g. "can you bump my metformin to 1000mg?", "what should I take for this headache?", "what's a good dinner recipe?")
